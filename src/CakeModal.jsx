        ...
        <div className="fixed inset-0 z-[100] bg-stone-900/80 backdrop-blur-md flex items-center justify-center p-4 animate-[fadeIn_0.5s_ease-out] overflow-hidden">
            ...
            {!isOpen && (
                ...
                >
                    ...
                    {/* Floating Icons around closed envelope */}
                    ...
                    <div className="overflow-y-auto p-6 md:p-12 custom-scrollbar relative z-10">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
                            ...
                            <div className="md:col-span-7 prose prose-rose prose-lg font-['Caveat'] text-2xl md:text-3xl leading-relaxed text-gray-700">
                                ...
                                <p>
                                    Como ves, esta carta es un poco diferente. Está llena de colores, gatitos y brillos <Sparkles className="inline w-5 h-5 text-yellow-400" />, justo como tú llenas mis días.
                                </p>
                                <p>
                                    Quería escribirte entre <b className="text-rose-500">flores</b> <Flower className="inline w-5 h-5 text-pink-400" /> y <b className="text-rose-500">mascotas</b> virtuales para decirte que eres mi persona favorita en todo el multiverso.
                                </p>
                                <p>
                                    Imagina que cada palabra aquí es un abrazo apretado. Gracias por tu dulzura, por ser ese "pastelito" que alegra cualquier tarde gris <Coffee className="inline w-5 h-5 text-brown-400" />.
                                </p>
                                <p>
                                    Nunca dejes de brillar, y si algún día se apaga la luz, aquí estaré yo (y estos gatitos <Cat className="inline w-5 h-5 text-gray-500" />) para recordarte lo increíble que eres.
                                </p>
                            ...
                            <div className="md:col-span-5 flex flex-col gap-6 items-center">
                                ...
                                <div className="relative transform rotate-3 hover:rotate-0 transition-transform duration-500 z-20 group w-full max-w-sm">
                                    ...
                                    <div className="bg-white p-3 pb-20 shadow-2xl border border-gray-100 rounded-sm">
                                        <img src={gatitoDuerme} className="w-full h-64 object-cover filter contrast-110 rounded-sm border border-gray-100" alt="Instax" />
                        ...
                        <div className="mt-12 text-center opacity-60 border-t border-rose-200 pt-4">
                            <p className="text-sm font-sans flex items-center justify-center gap-2">
                                <Music size={14} /> Enviado con mucho amor digital
                            </p>
                        </div>
